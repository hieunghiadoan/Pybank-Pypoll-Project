...
# Set path for data
csvpath = os.path.join("Users", "nghiadoanhieu", "Monash Bootcamp", "Homework" ,"Resources", "budget_data.csv")
pathout = os.path.join("Users", "nghiadoanhieu", "Monash Bootcamp", "Homework" "Analysis", "budget_analysis.txt")
